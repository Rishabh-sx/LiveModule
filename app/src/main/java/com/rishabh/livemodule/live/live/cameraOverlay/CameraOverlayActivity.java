...
public class CameraOverlayActivity extends BaseActivity implements CameraOverlayView, CompoundButton.OnCheckedChangeListener, CommentOverlayAdapter.CommentAdapterListener {
    ...
    */
    ...
    RelativeLayout userInteractableView;
    @BindView(R.id.statusView)
    StatusView statusView;
        ...
        public void call(Object... args) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    tvStatus.setText("Live video has ended");
    ...
    private String getStreamID() {
        return getIntent().getStringExtra("streamId");
    }
    ...
    private void setupReceivers() {
        liveActivityReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                //             Toast.makeText(CameraOverlayActivity.this,"Kuch to hua",Toast.LENGTH_SHORT).show();
...
//                tvStatus.setText("Disconnecting...");
            ...
            case "timer":
                ...
                if(!mServerStreamID.isEmpty() && !isAlreadyConnected) {
                    ...
                    endStream = true;
                    onBackPressed();
                    Toast.makeText(this,"You are already live from another device", Toast.LENGTH_LONG).show();
                }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.btn_status:
                userInteractableView.setVisibility(GONE);
                break;
            case R.id.tv_post:
                if (isPostShown) {
...
//                joinStream();
    ...
    private void sendBroadcastToToggleStream() {
        LocalBroadcastManager.getInstance(this)
                .sendBroadcast(new Intent("comment-overlay-activity-receiver")
    ...
    private void setViewsVisibility(int visibility) {
        ...
        if (visibility == View.VISIBLE) {
            ...
            userInteractableView.setVisibility(View.VISIBLE);
        }
    }
